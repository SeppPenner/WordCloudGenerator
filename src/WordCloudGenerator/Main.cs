...
namespace WordCloudGenerator
{
    ...
    using WordCloudGenerator.Interfaces.TransferObjects;
    using WordCloudGenerator.Models.Enumerations;
    using WordCloudGenerator.Models.FileOperations;
    using WordCloudGenerator.Models.ImportExport;
    using WordCloudGenerator.Models.TransferObjects;
    ...
    public partial class Main : Form
    {
        ...
        private void ButtonGenerateClick(object sender, EventArgs e)
        {
            try
            {
                ...
                var wordCloudGenerator = new WordCloudGenerator(this.languageManager)
                {
