...
AllowNoIcons=yes
LicenseFile=..\src\WordCloudGenerator\License.txt
OutputDir=..\Setup
OutputBaseFilename=WordCloudGenerator-Setup
SetupIconFile=..\src\WordCloudGenerator\Words.ico
Compression=lzma
...
[Files]
Source: "..\src\WordCloudGenerator\bin\Release\net5.0-windows\WordCloudGenerator.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\WordCloudGenerator\bin\Release\net5.0-windows\WordCloudGenerator.dll"; DestDir: "{app}"; Flags: ignoreversion
